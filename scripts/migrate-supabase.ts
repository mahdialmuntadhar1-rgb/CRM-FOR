...
async function checkUniqueConstraint(newClient: SupabaseClient): Promise<boolean> {
...
// Verify migration
async function verifyMigration(newClient: SupabaseClient, expectedCount: number): Promise<void> {
  console.log('\n🔍 Verifying migration...');
